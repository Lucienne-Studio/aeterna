          ...
          <section className="relative grid grid-cols-1 md:grid-cols-2 min-h-fit w-full max-w-[1440px] mx-auto">
            ...
            <main className="min-h-screen text-neutral-900 flex flex-col items-center p-8">
              <motion.section            
                ...
                <h2 className="text-xl font-semibold">Aeterna</h2>
          ...
          >
            ...
            <main className="flex flex-col items-center p-8 my-auto">
              <div className="mt-12 border-t pt-6 space-y-4 max-w-md">
                <h3 className="text-xl font-semibold nova uppercase">Aeterna Care</h3>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {expanded
                ? `Cadré watch, rectangular signature model with precision quartz movement, conceived as an exercise in proportion and restraint. A brushed steel case defined by architectural beveling frames a matte ivory dial, where minimal geometry replaces traditional ornamentation, and slim blued-steel baton hands move with quiet precision across a surface designed around balance and negative space. A recessed crown with a polished edge detail subtly interrupts the continuity of the form, while a black vegetable-tanned calfskin strap anchors the design with understated contrast, secured by a steel pin buckle. Case dimensions: 34.0 × 26.0 mm, thickness: 6.4 mm. Water-resistant up to 3 bar (approx. 30 meters/100 feet).`
                : `Cadré watch, rectangular signature model with precision quartz movement. Brushed steel case defined by architectural beveling, matte ivory dial, slim blued-steel baton hands, and black vegetable-tanned calfskin strap with steel pin buckle.`}
            </p>
        ...
        >
          ...
          <div className="max-w-xl">
            ...
            <p
              ...
              "
            >
              Your timepiece is supported by an extended international warranty of up to 5 years, 
              accompanied by a selection of dedicated services reserved for Aeterna clients.
            </p>
