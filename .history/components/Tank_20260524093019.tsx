      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {expanded
                ? `Cadré watch, rectangular signature 
                model with precision quartz movement, conceived as an
                 exercise in proportion and restraint. A brushed steel 
                 case defined by architectural beveling frames a matte ivory dial, 
                 where minimal geometry replaces traditional ornamentation, 
                 and slim blued-steel baton hands move with quiet precision 
                 across a surface designed around balance and negative space. 
                 A recessed crown with a polished edge detail subtly interrupts 
                 the continuity of the form, while a black vegetable-tanned 
                 calfskin strap anchors the design with understated contrast, 
                 secured by a steel pin buckle. Case dimensions: 34.0 × 26.0 mm, 
                 thickness: 6.4 mm. Water-resistant up to 3 bar`}
            </p>
