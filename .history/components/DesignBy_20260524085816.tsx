    ...
    >
      ...
      >
        <p
          ...
          "
        >
          © {new Date().getFullYear()} Lucienne. Concept reimagined for
          portfolio purposes by Richartistique Le Brassus. Media and original
          design © Cartier and respective owners.
        </p>
      </div>
    </section>
  );
